            ...
            <section>
                <div className="main-wrapper flex gap-[50px] justify-end items-center pt-[150px]">
                    <div className="main-left flex flex-col items-end gap-[20px]">
                        ...
                        <p style={{ fontFamily: 'cardo', fontWeight: 400 }} className=" text-black text-[18px]">
                            Modular Storage System
                        </p>
                        <p style={{ fontFamily: 'cardo', fontWeight: 400 }} className=" text-black text-[15px]">
                            From $1.176
                        </p>
                        <p style={{ fontFamily: 'cardo', fontWeight: 400 }} className=" text-[#54595F] text-[18px] w-[437px] text-end">
                        ...
                        <button
                            className="bg-transparent border-none text-[17px] text-black underline cursor-pointer"
                            type="button"
                        >
                            Shop now
                        </button>
