            ...
            <section>
                <div className="main-wrapper flex items-center justify-between pt-[70px]">
                    ...
                    <div className="card bg-white w-[360px] h-[370px] flex flex-col items-center justify-center">
                        ...
                        <p style={{ fontFamily: 'cardo', fontWeight: 400 }} className='text-[24px] text-black'>DESIGN</p>
                        <p style={{ fontFamily: 'cardo', fontWeight: 400 }} className='text-[15px] text-center w-[285px] mx-auto pt-[12px]' >We create furniture pieces with personality, designed to transform your space.</p>
                        <p style={{ fontFamily: 'cardo', fontWeight: 400 }} className='text-[15px] text-center underline text-black pt-[30px]'>Learn More</p>
                    </div>
