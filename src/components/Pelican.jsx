    ...
    <div>
      ...
      <section>
        <div className="main-wrapper flex gap-[50px] justify-start items-center pt-[150px]">
          ...
          <div className="main-left flex flex-col items-start gap-5">
            ...
            <p
              style={{ fontFamily: "cardo", fontWeight: 400 }}
              className="text-[#54595F] text-[18px] w-[437px] text-start"
            >
            ...
            <p className="font-sans font-light text-[16px] text-[#54595F]">
